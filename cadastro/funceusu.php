    ...
    <form action="insere_cad.php" method="post" id="cadastroForm">
		...
		<div class="row"> 
			...
			<div class="form-group col-md-4">
                ...
                <input type="text" class="form-control" name="rua_end" required>
            </div>
			<div class="form-group col-md-4">
                <label for="compl_end">Complemento</label>
                <input type="text" class="form-control" name="compl_end" required>
            </div>
			<div class="form-group col-md-4">
			...
			<div class="row">
				<div class="form-group col-md-4">
								...
								<input type="text" class="form-control" name="bairro_end" required>
							</div>
				<div class="form-group col-md-4">
								<label for="cidade_end">Cidade</label>
								<input type="text" class="form-control" name="cidade_end" required>
							</div>
				<div class="form-group col-md-4">
								<label for="estado_end">Estado</label>
								<input type="text" class="form-control" name="estado_end" required>
							</div>
			</div>
