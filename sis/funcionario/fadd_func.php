	...
	<form action="?page=insere_func" method="post">
		...
		<div class="row"> 
			<div class="form-group col-md-2">
				...
				<input type="number" class="form-control" name="cep_end" id="cep">
			</div>

			<div class="form-group col-md-6">
				<label for="rua_end">Rua</label>
				<input type="text" class="form-control" name="rua_end" id="rua">
			</div>
		</div>
		<!-- 3ª LINHA -->
		<div class="row"> 
		...
		 
			<div class="form-group col-md-4">
				...
				<input type="text" class="form-control" name="bairro_end" id="bairro">
			</div>

			<div class="form-group col-md-4">
				<label for="cidade_end">Cidade</label>
				<input type="text" class="form-control" name="cidade_end" id="cidade">
			</div>

			<div class="form-group col-md-4">
				<label for="estado_end">Estado</label>
				<input type="text" class="form-control" name="estado_end" id="estado">
			</div>
